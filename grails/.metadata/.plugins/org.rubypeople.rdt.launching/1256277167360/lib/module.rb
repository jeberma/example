...
------------------------------------------------------------------------
     Extends the module object with module and instance accessors for
...
Includes:
---------
     ActiveSupport::CoreExtensions::Module(alias_attribute,
     alias_method_chain, local_constant_names, local_constants,
     model_name, parent, parent_name, parents),
...
-----------------
     ...
     append_features, as_load_path, attr, attr_accessor,
     attr_accessor_with_default, attr_internal, attr_internal_accessor,
     attr_internal_reader, attr_internal_writer, attr_reader,
     attr_writer, autoload, autoload?, class_eval,
     class_variable_defined?, class_variable_get, class_variable_set,
     class_variables, const_defined?, const_get, const_missing,
     const_set, constants, debug_method, define_method, delegate,
     extend_object, extended, freeze, include, include?, included,
     included_in_classes, included_modules, instance_method,
     instance_methods, mattr_accessor, mattr_reader, mattr_writer,
     method_added, method_defined?, method_removed, method_undefined,
     module_eval, module_function, name, post_mortem_method, private,
     ...
     remove_class_variable, remove_const, remove_method, synchronize,
     to_s, undef_method
