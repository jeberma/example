...
---------
     ...
     collect, detect, each_cons, each_slice, each_with_index,
     each_with_object, entries, enum_cons, enum_slice, enum_with_index,
     find, find_all, grep, group_by, include?, index_by, inject, many?,
     map, max, member?, min, none?, partition, reject, select, sort,
     sort_by, sum, to_a, to_set, zip)
...
-----------------
     ...
     size, slice, slice!, split, squeeze, squeeze!, starts_with?, strip,
     strip!, sub, sub!, succ, succ!, sum, swapcase, swapcase!, to_blob,
     to_date_lex, to_date_time_lex, to_f, to_i, to_i_lex, to_s, to_str,
     to_sym, to_time_lex, to_xs, to_yaml, toeuc, tojis, tosjis, toutf16,
