...
Class methods:
--------------
     find_hidden_method, lookup_missing_generator, method_added, new


Instance methods:
-----------------
     ==, ===, =~, __id__, __send__, acts_like?, blank?, class,
     class_eval, clone, dclone, display, dup, duplicable?, enum_for,
     eql?, equal?, extend, freeze, frozen?, hash, id, inspect,
     instance_eval, instance_exec, instance_of?,
     instance_variable_defined?, instance_variable_get,
     instance_variable_hash, instance_variable_names,
     instance_variable_set, instance_variables, is_a?, kind_of?,
     metaclass, method, methods, nil?, object_id, or_ask, present?,
     private_methods, protected_methods, public_methods,
     remove_instance_variable, respond_to?, returning, send,
     singleton_method_added, singleton_method_removed,
     singleton_method_undefined, singleton_methods, taint, tainted?,
     tap, to_a, to_enum, to_json, to_param, to_query, to_s, to_yaml,
     to_yaml_properties, to_yaml_style, try, type, untaint, with_options
