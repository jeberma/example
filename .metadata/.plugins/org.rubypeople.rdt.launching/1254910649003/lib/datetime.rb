...
---------
     ...
     compare_with_coercion, end_of_day, future?, getutc, in, midnight,
     past?, seconds_since_midnight, since, utc, utc?, utc_offset),
     ActiveSupport::CoreExtensions::DateTime::Conversions(formatted_offs
     et, readable_inspect, to_date, to_datetime, to_f, to_formatted_s,
     to_time, xmlschema),
     ActiveSupport::CoreExtensions::Time::Behavior(acts_like_time?),
     ActiveSupport::CoreExtensions::Time::Zones(in_time_zone)
